        ...
        static Repostory(){
            ...
            products.Add(new ProductModel { ProductId = 1, Name = "Iphone 15", Price = 80000,image= "Iphone15.jpg" ,CategoryId = 1, IsActive = true });
             products.Add(new ProductModel { ProductId = 2, Name = "Iphone 15 Pro", Price = 100000,image= "Iphone15Pro.jpg" ,CategoryId = 1, IsActive = true });
              products.Add(new ProductModel { ProductId = 3, Name = "Macbook Air", Price = 90000,image= "Mac1.jpg" ,CategoryId = 2, IsActive = true });
               products.Add(new ProductModel { ProductId = 4, Name = "Macbook Pro", Price = 120000,image= "Mac2.jpg" ,CategoryId = 2, IsActive = true });
        }
